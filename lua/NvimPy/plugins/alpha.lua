return {
    {
        ...
        opts = function()
            ...
            local function button(sc, txt, keybind, hl_opts, keybind_opts)
                ...
                local function on_press()
                    local key = vim.api.nvim_replace_termcodes(
                                    keybind or sc_ .. "<Ignore>", true, false,
                                    true)
            ...
            local Info = function()
                ...
                local info = "[ " .. datetime .. " -*- " .. "Vim version = " ..
                                 ver.major .. "." .. ver.minor .. " ]"
                return {
                    type = "text",
                    val = info,
            ...
            local function file_button(fn, sc, short_fn, autocd)
                ...
                if nvim_web_devicons.enabled then
                    ...
                    if hl_option_type == "string" then
                        table.insert(fb_hl,
                                     {nvim_web_devicons.highlight, 0, #ico})
                    end
                    ico_txt = ico .. "  "
                else
                    ico_txt = ""
                ...
                if fn_start ~= nil then
                    table.insert(fb_hl, {
                        "Comment", #ico_txt - 2, #fn_start + #ico_txt
                    })
                end
            ...
            local function mru(start, cwd, items_number, opts)
                ...
                for _, v in pairs(vim.v.oldfiles) do
                    ...
                    local ignore = (opts.ignore and
                                       opts.ignore(v, get_extension(v))) or
                                       false
                ...
                for i, fn in ipairs(oldfiles) do
                    ...
                    if #short_fn > target_width then
                        short_fn = plenary_path.new(short_fn):shorten(1,
                                                                      {-2, -1})
                        if #short_fn > target_width then
                            short_fn = plenary_path.new(short_fn):shorten(1,
                                                                          {-1})
                    ...
                    local file_button_el =
                        file_button(fn, shortcut, short_fn, opts.autocd)
            ...
            local butts = {
                ...
                val = {
                    {type = "padding", val = 1},
                    button("f", "  Find file",
                           "<Cmd> Telescope find_files <CR>", "NvimPyBlue"),
                    button("e", "  New file",
                           "<Cmd> ene <BAR> startinsert <CR>", "NvimPyCyan"),
                    button("r", "  Recently used files",
                           "<Cmd> Telescope oldfiles <CR>", "NvimPyYellow"),
                    button("t", "  Find text",
                           "<Cmd> Telescope live_grep <CR>", "NvimPyGreen"),
        ...
        config = function(_, Conf)
            ...
            vim.api.nvim_create_autocmd("User", {
                ...
                callback = function()
                    ...
                    Conf.layout[6] = {
                        type = "text",
                        val = "  NvimPy loaded " .. stats.loaded .. "/" ..
