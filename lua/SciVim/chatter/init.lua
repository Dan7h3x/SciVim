...
function Chatter:open_chat_sidebar()
	...
	api.nvim_buf_set_keymap(
		...
		"n",
		"q",
		'<cmd>lua require("SciVim.chatter").close_sidebar()<CR>',
		opts
	)
	api.nvim_buf_set_keymap(
		self.sidebar_bufnr,
		"n",
		"<C-c>",
		'<cmd>lua require("SciVim.chatter").clear_chat()<CR>',
		opts
	)
	api.nvim_buf_set_keymap(
		self.sidebar_bufnr,
		"n",
		"<C-r>",
		'<cmd>lua require("SciVim.chatter").restart_chat()<CR>',
		opts
	)
	api.nvim_buf_set_keymap(
		self.sidebar_bufnr,
		"n",
		"i",
		'<cmd>lua require("SciVim.chatter").prompt_user_input()<CR>',
		opts
	)
