...
option.cursorlineopt = "screenline,number"
...
option.inccommand = "split" -- preview incremental substitute
...
option.switchbuf = 'usetab' -- Use already opened buffers when switching
option.swapfile = false
option.shada = "'100,<50,s10,:1000,/100,@100,h"
option.shortmess = 'CFOSWaco'
...
option.wildmode = "full"     -- Command-line completion mode
option.wildoptions = "fuzzy,pum"
option.winblend = 0
