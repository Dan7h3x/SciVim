...
function M.foldtext()
	...
	table.insert(ret, { " " .. require("SciVim.extras.icons").misc.dots })
...
function M.statuscolumn()
	...
	local show_open_folds = vim.g.scivim_statuscolumn and vim.g.scivim_statuscolumn.folds_open
	local use_githl = vim.g.scivim_statuscolumn and vim.g.scivim_statuscolumn.folds_githl
