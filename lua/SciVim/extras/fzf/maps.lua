local keys = {
	...
	},
	{
		"<leader>gh",
		function()
			require("fzf-lua").git_hunks({ path_shorten = true })
		end,
		desc = "Git Diff (hunks)",
	},
	{
	...
	},
	{
		"<leader>gS",
		function()
			require("SciVim.extras.fzf.cmds").git_status_tmuxZ({
				winopts = {
					fullscreen = true,
	...
	},
	{
		...
		desc = "Buffer Lines (word)",
		mode = { "n" },
	},
	{
		"<leader>/",
		function()
			require("fzf-lua").blines({ start = "cursor" })
		end,
		desc = "Buffer Lines",
		mode = { "n", "v" },
	},
