...
local fn = require("SciVim.extras.ollama_utils")
      ...
      handler = function()
        ...
        local prompt = fn.switch(state.selected_option, {
          ...
          ["enhance-grammar"] = function()
            return
                "Modify the following text to improve grammar and spelling, just output the final text in English without additional quotes around it:\n"
                .. state.text
          end,
