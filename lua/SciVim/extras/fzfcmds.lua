...
local utils = require("SciVim.extras.fzftools")
...
function M.diagnostics_document(opts)
	opts = opts or {}
	opts.diag_source = #utils.lsp_get_clients({ bufnr = vim.api.nvim_get_current_buf() }) > 1 and true or false
...
function M.workdirs(opts)
	...
	opts.actions = {
		["default"] = function(selected)
			...
			require("SciVim.extras.fzftools").set_cwd(newcwd)
		end,
	}
