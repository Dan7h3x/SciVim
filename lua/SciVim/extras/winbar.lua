...
local opts = {
	...
	icons = {
		...
		kinds = {
			use_devicons = true,
			symbols = {
				Array = Icons.kind_icons.Array,
				Boolean = Icons.kind_icons.Boolean,
				BreakStatement = "󰙧 ",
				Call = "󰃷 ",
				CaseStatement = "󱃙 ",
				Class = Icons.kind_icons.Class,
				Color = Icons.kind_icons.Color,
				ContinueStatement = "→ ",
				Constant = Icons.kind_icons.Constant,
				Constructor = "﵅ ",
				Copilot = " ",
				Declaration = "󰙠 ",
				Delete = "󰩺 ",
				DoStatement = "󰑖 ",
				Enum = Icons.kind_icons.Enum,
				EnumMember = Icons.kind_icons.EnumMember,
				Event = Icons.kind_icons.Event,
				Field = Icons.kind_icons.Field,
				File = Icons.kind_icons.File,
				Folder = Icons.kind_icons.Folder,
				ForStatement = "󰑖",
				Function = Icons.kind_icons.Function,
				Identifier = "󰀫 ",
				IfStatement = "󰇉 ",
				Interface = " ",
				Keyword = "󰌋 ",
