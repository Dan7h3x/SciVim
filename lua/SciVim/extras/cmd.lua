  ...
  default = {
    winopts = {
      title = {
        { "", "SciVimBlue" },
        { "  ", "SciVimBlue" },
        { "v" .. vim.version().major .. "." .. vim.version().minor .. " ", "SciVimBlue" },
        { "", "SciVimBlue" },
      },
      title_pos = "right"
    },
    ...
    icon = { { " 󰣖 ", "SciVimBlue" } },
    winhl = "FloatBorder:SciVimBlue,Normal:Normal",
    ft = "vim"
  },
  configs = {
    {
      ...
      winopts = function(state)
        ...
        elseif prompt:match("^Remove selection") then
          ...
          return {
            title = {
              { "", "SciVimRed" },
              { " 󰆴 Delete: " .. items .. (tonumber(items) == 1 and " item " or " items "), "SciVimRed" },
              { "", "SciVimRed" },
            },
            footer = {
              { "╼", "SciVimRed" },
          ...
          return {
            title = {
              { "", "SciVimCyan" },
              { " " .. (state.prompt or "Input:") .. " ", "SciVimCyan" },
              { "", "SciVimCyan" },
            }
          };
        end
      ...
      winhl = function(state)
        ...
        if prompt:match("^Create:%s") then
          return "FloatBorder:SciVimGreen,Normal:Normal";
        elseif prompt:match("^Rename:%s") then
          return "FloatBorder:SciVimYellow,Normal:Normal";
        elseif prompt:match("^Remove selection") then
          return "FloatBorder:SciVimRed,Normal:Normal";
        else
          return "FloatBorder:SciVimCyan,Normal:Normal";
        end
      end
    },
    {
    ...
    },
    {
      ...
      winopts = {
        title = {
          { "", "SciVimPurple" },
          { "  " .. _VERSION .. " ", "SciVimPurple" },
          { "", "SciVimPurple" },
        },
        title_pos = "right"
      },

      winhl = "FloatBorder:SciVimPurple,Normal:Normal",
      icon = { { "  ", "SciVimPurple" } },
      ft = "lua",
    ...
    },
    {
      ...
      winopts = {
        title = {
          { "", "SciVimOrange" },
          { " 󰍉 Search ", "SciVimOrangeBg" },
          { "", "SciVimOrange" },
        },
        title_pos = "right"
      },
      icon = { { "  ", "SciVimOrange" } },
      winhl = "FloatBorder:SciVimOrange,Normal:Normal"
    },
    {
      firstc = "/",
      winopts = {
        title = {
          { "", "SciVimYellow" },
          { " 󰍉 Search ", "SciVimYellowBg" },
          { "", "SciVimYellow" },
        },
        title_pos = "right"
      },
      icon = { { "  ", "SciVimYellow" } },
      winhl = "FloatBorder:SciVimYellow,Normal:Normal"
    },
    {
      firstc = "=",
      winopts = {
        title = {
          { "", "SciVimGreen" },
          { "  Calculate ", "SciVimGreenBg" },
          { "", "SciVimGreen" },
        },
        title_pos = "right"
      },
      icon = { { " 󰇼 ", "SciVimGreen" } },
      winhl = "FloatBorder:SciVimGreen,Normal:Normal"
    },
  },
...
cmd.open_completion = function()
  ...
  vim.api.nvim_win_set_config(cmd.win, vim.tbl_extend("force", {
    ...
    row = math.floor((vim.o.lines - (h + cmp_h)) / 1),
    col = math.floor((vim.o.columns - w) / 2),
