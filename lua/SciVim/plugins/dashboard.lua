return {
  {
    ...
    opts = function()
      ...
      local function header_color()
        local lines = {}
        for _, lineConfig in pairs(Logo) do
          local hi = "Label"
          local line = {
            type = "text",
            val = lineConfig,
      ...
      local section_mru = {
        ...
        val = {
          ...
          -- { type = "padding", val = 1 },
          {
            ...
            opts = { hl = "CursorLineNr", shrink_margin = false, position = "center" },
          },
        },
      }
      ...
      local butts = {
        ...
        val = {
          ...
          -- },
          { type = "padding", val = 3 },
          button("f", " Find file", "<Cmd>FzfLua files<CR>", "String"),
          { type = "padding", val = 1 },
          button("e", " New file", "<Cmd> ene <BAR> startinsert <CR>", "Label"),
          { type = "padding", val = 1 },
          button("r", " Recently used files", "<Cmd>FzfLua oldfiles<CR>", "Constant"),
          { type = "padding", val = 1 },
          button("t", "󰊄 Find text", "<Cmd>FzfLua live_grep<CR>", "Character"),
          { type = "padding", val = 1 },
          button("l", "󰏓 Lazy", "<Cmd> Lazy <CR>", "Type"),
          { type = "padding", val = 1 },
          button(
            "d",
            "󰥨 Find Projects",
          ...
          { type = "padding", val = 1 },
          button("q", "󰩈 Quit Neovim", "<Cmd> qa<CR>", "ErrorMsg"),
          { type = "padding", val = 1 },
        },
        position = "center",
      }
