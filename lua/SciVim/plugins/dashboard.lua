		...
		opts = function()
			...
			local butts = {
				...
				val = {
					...
					-- },
					{ type = "padding", val = 3 },
					button("f", " Find file", "<Cmd>FzfLua files<CR>", "Green"),
					{ type = "padding", val = 1 },
					button("e", " New file", "<Cmd> ene <BAR> startinsert <CR>", "Cyan"),
					{ type = "padding", val = 1 },
					button("r", " Recently used files", "<Cmd>FzfLua oldfiles<CR>", "Orange"),
					{ type = "padding", val = 1 },
					button("t", "󰊄 Find text", "<Cmd>FzfLua live_grep<CR>", "Teal"),
					{ type = "padding", val = 1 },
